			...
			<div class="row">
				<div class="col-lg-12 grid-margin stretch-card">
					<div class="card"  style="border: 2px solid #2196f3; border-radius: 5px;">
						<div class="card-body">
							<h4 style="color: #2196f3;">What's new in 4.0.0</h4>
							<ul>
								<li>1. Updated Menu Navigation in Left Sidebar.</li>
								<li>2. Now, You can use this plugin with any caching plugins. ( Plugin Settings >> Advanced Settings.</li>
								<li>3. Now, you can show your counters with k, m digits. Like >> 1000 = 1k.</li>
								<li>4. New Chart added on dashboard.</li>
								<li>5. Device / Browser Detection Module updated.</li>
								<li>6. Settings Pages / Shortcode pages UI updated.</li>
								<li>7. Minor bug fixes and speed improvements.</li>
							...
							<a href="<?php 
            echo  admin_url() ;
            ?>admin.php?page=apvc-dashboard-page&clr=yes" class="btn btn-icons btn-primary float-right" style="width: 200px">Close</a>
						</div>
					</div>
				</div>
			</div>
